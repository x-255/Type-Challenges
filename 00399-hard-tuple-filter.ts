...
// ============= Your Code Here =============
type FilterOut<T extends any[], F, K extends any[] = []> = T extends [infer A, ...infer B]
  ? FilterOut<B, F, [A] extends [F] ? K : [...K, A]>
  : K

type P = FilterOut<[never, 1, 'a', undefined, false, null], never | null | undefined>
